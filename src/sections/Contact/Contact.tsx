...
const Contact: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-screen-xl flex flex-col md:flex-row gap-20 md:gap-20 justify-center items-center md:justify-between md:items-start">
          <motion.div
          ...
          className="flex-1 flex flex-col gap-10 lg:gap-20">
            <div className="flex flex-col justify-center items-center md:items-start gap-5">
              <Header className="hidden md:flex">Contact</Header>
              <Header orientation="center" className=" md:hidden">Contact</Header>
              <p>Hit me up if you have some questions or just want to chat!</p>
              <div className="flex flex-col gap-2 py-10 text-xl items-center md:items-start tracking-widest">
          ...
          className="flex-1 flex flex-col gap-10 lg:gap-20">
            <div className="flex flex-col justify-center items-end gap-5">
              ...
              <Header orientation="center" className="md:hidden">
                Use This Form
              </Header>
              <form
